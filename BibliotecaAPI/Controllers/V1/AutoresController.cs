...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class AutoresController : ControllerBase
    {
        ...
        [HttpGet("/v1/lista-autores")] // En este ejemplo tenemos una acción que puede ser accedida con 2 endpoints distintos
        ...
        [HttpGet("/v1/listado-de-autores")] // Al ponerle "/" automáticamente se salta el enrutado del controlador y es esa url: https://localhost:7298/listado-de-autores
        [AllowAnonymous]
        [OutputCache(Tags = [cache])]
