...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class LibrosController : ControllerBase
    {
        ...
        [HttpGet("v1/listado/obtener-token")]
        [AllowAnonymous]
        public ActionResult ObtenerTokenListado()
        {
            ...
            var url = Url.RouteUrl("ObtenerListadoLibrosUsandoTokenV1", new { token }, Request.Scheme);

            return Ok(new { url });
        }


        [HttpGet("v1/listado/{token}", Name = "ObtenerListadoLibrosUsandoTokenV1")]
        [AllowAnonymous]
